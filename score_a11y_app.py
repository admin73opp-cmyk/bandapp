#!/usr/bin/env python3
# ============================================================================
#  score_a11y_app.py  —  MEASURING STICK FOR ASSET 8  (LOCKED)
# ============================================================================
#  Defines the ONE number we optimize for asset 8: the impact-weighted count
#  of axe-core accessibility violations across the LOGGED-IN Ritovo app —
#  all 11 pages, scanned with realistic data. LOWER IS BETTER. Output: an
#  integer, or "INVALID".
#
